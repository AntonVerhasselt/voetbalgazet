# Plans — AI Journalist / Pipeline

| Doc | Summary |
|-----|---------|
| [00-overview.md](./00-overview.md) | Master map + locked decisions |
| [01-architecture-and-data-model.md](./01-architecture-and-data-model.md) | Pipeline tables & phases |
| [02-research-agent-eve.md](./02-research-agent-eve.md) | Eve agent (`zai/glm-5.2`) |
| [03-admin-ux-pipeline.md](./03-admin-ux-pipeline.md) | `/admin/pipeline` UX |
| [04-convex-orchestration.md](./04-convex-orchestration.md) | Runs, per-division lock, waiter |
| [05-implementation-phases.md](./05-implementation-phases.md) | Build order |
| [06-open-questions.md](./06-open-questions.md) | Full decision log |
