...
3. The agent identity is linked to an app `users` row with a **fixed, least-privilege role** (default `journalist`).
4. This unlocks **custom Convex admin** only (overview, later nieuwsbrieven/abonnees/instellingen).
