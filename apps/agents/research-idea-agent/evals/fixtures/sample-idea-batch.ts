import type { IdeaBatch } from "../../agent/lib/idea-batch";

/**
 * Schema-valid Dutch fixture for shape / language evals.
 * Clearly fictional clubs — not Neon-grounded (source convex / voorbeelddata).
 */
export const sampleIdeaBatch: IdeaBatch = {
  ideas: [
    {
      ...
      whyInteresting:
        "FC Voorbeeld stond na vijf speeldagen nog laatste, maar leidt nu de reeks. Dat contrast leent zich voor een data-gedreven portret van de ommekeer.",
      supportingFacts: [
        {
